      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 md:items-start max-w-3xl mx-auto">
          ...
          >
            ...
            <a
              href="#"
              className="mt-8 block rounded-full border border-iris-500/40 px-6 py-3 text-center text-sm font-semibold text-iris-300 transition-all hover:border-iris-500/70 hover:bg-iris-700/10 hover:text-white"
            >
              Assinar agora
            </a>
          ...
          >
            ...
            <a
              href="#"
              className="relative mt-8 block rounded-full bg-gradient-to-r from-iris-700 to-iris-500 px-6 py-3 text-center text-sm font-semibold text-white shadow-lg shadow-iris-700/25 transition-all hover:brightness-110 hover:shadow-xl hover:shadow-iris-700/35"
            >
              Comprar agora
            </a>
